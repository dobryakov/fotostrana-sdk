...
define('FOTOSTRANA_APPID', 'sdkdemo'); // ваш APP_ID
define('FOTOSTRANA_CLIENTKEY', 'a84aedc74dda60a3cf35a96683ae0947'); // клиентский ключ
define('FOTOSTRANA_SERVERKEY', 'c95e03377ca085d6f82c9b39fbf9336e'); // серверный ключ

// вы можете использовать тестовые адреса для отладки,
// а для реального использования замените fs98.vs58.net на fotostrana.ru в обоих строках
define('FOTOSTRANA_URL', 'http://fs98.vs58.net');
define('FOTOSTRANA_API_BASEURL', 'http://fs98.vs58.net/apifs.php');

// параметры для совместимости с oAuth-авторизацией (появится в Фотостране в обозримом будущем)
...
// в эти константы заносятся соответствующие значения из строки iframe при загрузке вашего приложения
